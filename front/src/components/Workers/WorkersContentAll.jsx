                    ...
                    <Segment inverted color="grey">
                        <Segment>
                            <Grid columns={16}>
                                ...
                                <GridColumn width={3}>First Name</GridColumn>
                                <GridColumn width={3}>Last Name</GridColumn>
                                <GridColumn width={4}>Phone number</GridColumn>
                                <GridColumn width={3}>Username</GridColumn>
                            </Grid>
                        </Segment>
