                    ...
                    <Segment inverted color="grey">
                        <Segment>
                            <Grid columns={16}>
                                ...
                                <GridColumn width={3}>Species</GridColumn>
                                <GridColumn width={3}>Name</GridColumn>
                                <GridColumn width={3}>Birth date</GridColumn>
                                <GridColumn width={3}>Health</GridColumn>
                                <GridColumn width={2}>Age</GridColumn>
                            </Grid>
                        </Segment>
